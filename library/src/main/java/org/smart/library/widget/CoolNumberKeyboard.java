...
import org.smart.library.listener.OnChoiceListener;
 ...
 * @version 1.1 2015-09-14 替换中文为ASCII码值 update by Liangzichao
 */
public class CoolNumberKeyboard {
    ...
    private void changeBackground(int id) {
        for (TextView view : mNumber) {
            view.setBackgroundResource(view.getId() == id ? R.drawable.check_gray : R.drawable.keyboard_bg_number);
        }
    }
