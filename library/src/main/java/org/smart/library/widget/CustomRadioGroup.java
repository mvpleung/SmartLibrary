...
public class CustomRadioGroup extends LinearLayout {
    ...
    public CustomRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.CustomRadioGroup, android.R.attr.radioButtonStyle, 0);

        int value = attributes.getResourceId(R.styleable.CustomRadioGroup_android_checkedButton, View.NO_ID);
        if (value != View.NO_ID) {
            mCheckedId = value;
        }

        final int index = attributes.getInt(R.styleable.CustomRadioGroup_android_orientation, LinearLayout.VERTICAL);
    ...
    private void setCheckedStateForView(int viewId, boolean checked) {
        ...
        if (checkedView != null && checkedView instanceof CompoundButton) {
            CompoundButton mCompoundButton = (CompoundButton) checkedView;
            mCheckedTag = (String) mCompoundButton.getTag();
