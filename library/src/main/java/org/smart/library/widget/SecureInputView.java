...
import org.smart.library.listener.OnCompleteListener;
...
public class SecureInputView extends EditText implements View.OnFocusChangeListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            passwordLength = a.getInt(R.styleable.SecureInputView_android_maxLength, defaultPasswordLength);
    ...
    private void initRect() {
        ...
        rectIn = new RectF(rectOut.left + borderWidth, rectOut.top + borderWidth, rectOut.right - borderWidth, rectOut.bottom - borderWidth);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < textLength; i++) {
            ...
            if (!displayPassWord) {
                ...
                // cx = width * i / passwordLength + half;
                float textWidth = passwordPaint.measureText(String.valueOf(singlePassWord));
                cx = width * i / passwordLength + half - textWidth / 2;
                ...
                mCountDownTimer = new CountDownTimer(300, 100) {
                    ...
                    public void onFinish() {
                        if (textLength == passwordLength)
                            mOnCompleteListener.onComplete(getText().toString());
                    }
                };
