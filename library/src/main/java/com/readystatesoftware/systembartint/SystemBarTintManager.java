...
/**
 * Liangzc updated on 2016/1/12
 * Support MIUI or  Flyme for darkMode
...
public class SystemBarTintManager {
    ...
    private static boolean sIsMiui, sIsFlyme;

    static {
        try {
            Class<?> sysClass = Class.forName("android.os.SystemProperties");
            Method getStringMethod = sysClass.getDeclaredMethod("get", String.class);
            String mMiuiVerion = (String) getStringMethod.invoke(sysClass, "ro.miui.ui.version.name");
            sIsMiui = TextUtils.isEmpty(mMiuiVerion) ? false : "V6".compareTo(mMiuiVerion) <= 0;
    ...
    @TargetApi(19)
    public void setTranslucentStatus(Window window, boolean on) {
     ...
     * @param activity
     */
    public boolean setStatusBarDarkMode(boolean darkmode, Activity activity) {
