...
public abstract class QuickAdapter<T> extends BaseQuickAdapter<T, BaseAdapterHelper> {
	 ...
	 */
	public QuickAdapter(Context context, ItemTypeSupport<T> mItemTypeSupport) {
		super(context, null, mItemTypeSupport);
	}
	 ...
	 * @param mItemTypeSupport
	 */
	public QuickAdapter(Context context, List<T> data, ItemTypeSupport<T> mItemTypeSupport) {
		super(context, data, mItemTypeSupport);
	}

	protected BaseAdapterHelper getAdapterHelper(int position, View convertView, ViewGroup parent) {
		return get(context, convertView, parent, mItemTypeSupport != null ? mItemTypeSupport.getLayoutId(position, getItem(position)) : layoutResId, position);
	}
