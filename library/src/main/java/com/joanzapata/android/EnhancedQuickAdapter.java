...
public abstract class EnhancedQuickAdapter<T> extends QuickAdapter<T> {
	 ...
	 */
	public EnhancedQuickAdapter(Context context, ItemTypeSupport<T> mItemTypeSupport) {
	 ...
	 * @param mItemTypeSupport
	 */
	public EnhancedQuickAdapter(Context context, List<T> data, ItemTypeSupport<T> mItemTypeSupport) {
