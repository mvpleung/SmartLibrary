...
import com.exiaobai.library.control.AppConfig.AppRequestCode;
import com.exiaobai.library.control.AppConfig.AppSharedName;
import com.exiaobai.library.listener.OnExtraEventListener;
import com.exiaobai.library.widget.ChoiceDialog;
import com.exiaobai.library.widget.ConfirmDialog;
import com.exiaobai.library.widget.DateWeekDialog;
import com.exiaobai.library.widget.DateWeekDialog.DateWeekCallback;
import com.exiaobai.library.widget.LoadingDialog;
...
public class UITools {
	...
	private static void showOrCreateToast(Context ctx, CharSequence msg, int duration) {
		if (mToast == null)
			...
			LogUtils.i("Toast.mView :" + mView);
			if (mView == null) {
				mToast = Toast.makeText(ctx, msg, duration);
			} else {
				View mTextView = mView.findViewById(android.R.id.message);
				LogUtils.i("Toast.mTextView :" + mTextView);
				if (mTextView == null) {
					mToast = Toast.makeText(ctx, msg, duration);
				} else {
					mToast.setText(msg);
	 ...
	 * @return
	 */
	public static ConfirmDialog createConfirmDialog(Context context, String title, CharSequence msg, CharSequence msgDesc, View.OnClickListener negativeClick, String negative, View.OnClickListener positiveClick, String positive, boolean isAutoDismiss) {
	 ...
	 * @return
	 */
	public static ConfirmDialog createSingleConfirmDialog(Context context, String title, CharSequence msg, CharSequence msgDesc, View.OnClickListener positiveClick, String positive, boolean isAutoDismiss) {
		isBtnAutoClose = isAutoDismiss;
		if (!TextUtils.isEmpty(msgDesc)) {
			Resources resources = context.getResources();
			SpannableString wordtoSpan = new SpannableString(msg + "\n" + msgDesc);
	 ...
	 * @return
	 */
	public static ConfirmDialog showConfirmDialog(Context context, String title, CharSequence msg, CharSequence msgDesc, View.OnClickListener negativeClick, String negative, View.OnClickListener positiveClick, String positive) {
	 ...
	 * @return
	 */
	public static ConfirmDialog showConfirmDialog(Context context, String title, CharSequence msg, CharSequence msgDesc, View.OnClickListener negativeClick, String negative, View.OnClickListener positiveClick, String positive, boolean isAutoDismiss) {
	...
	public static ListView createCustomListView(Context context, OnScrollListener customListener) {
		...
		mListView.setOnScrollListener(new PauseOnScrollListener(BitmapHelper.getInstance().getImageLoader(), true, false, customListener));
		return mListView;
	}
	 ...
	 * @return
	 */
	private static View.OnClickListener getOnClickListener(View.OnClickListener onClickListener) {
		if (onClickListener == null)
			return onClickListener;
		final View.OnClickListener clickListener = onClickListener;
	...
	public static void setListViewHeightBasedOnChildren(ListView listView) {
		...
		for (int i = 0; i < listAdapter.getCount(); i++) {
			...
			LogUtils.i("setListViewHeightBasedOnChildren, totalHeight:" + totalHeight);
		}
