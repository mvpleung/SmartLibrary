...
import com.exiaobai.library.control.AppContext;
...
import com.exiaobai.library.tools.NetworkProber;
...
public class UpdateActivity extends Activity {
	...
	private void downloadApk() {
		...
		httpHandler = mHttpUtils.download(downloadUrl, sb.toString(), true, true, new RequestCallBack<File>() {
	 ...
	 * 下载失败
	 */
	private void onFail(HttpException arg0) {
