...
import com.exiaobai.library.adapter.AlbumAdapter;
import com.exiaobai.library.adapter.PhotoSelectorAdapter;
import com.exiaobai.library.adapter.PhotoSelectorAdapter.OnItemCheckedListener;
import com.exiaobai.library.control.AlbumController;
import com.exiaobai.library.control.AlbumController.OnLocalListener;
...
import com.exiaobai.library.tools.Toolkit;
 ...
 * @author LiangZiChao
 * @Data 2015年7月9日
 * @Package net.gemeite.merchant.ui.photo
 */
...
public class PhotoSelectorActivity extends Activity implements OnLocalListener, OnClickListener {
	...
	public void initUI() {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
			...
			mTintManager.setStatusBarTintResource(R.mipmap.statusbar_bg);
		}
	...
	public void initData() {
		...
		gvPhotos.setOnScrollListener(new PauseOnScrollListener(BitmapHelper.getInstance().getImageLoader(), true, false));
	...
	private void initListDirPopupWindw() {
		...
		mListDir.setOnScrollListener(new PauseOnScrollListener(BitmapHelper.getInstance().getImageLoader(), true, false));
