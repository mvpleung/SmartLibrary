 ...
 */
public class PhotoPreviewActivity extends Activity implements View.OnClickListener, OnPageChangeListener {
	...
	private void initData() {
		...
		if (photos != null) { // 预览图片
			if (extras.getBoolean(EDIT_MODE)) {
				...
				mImageDelete.setImageResource(R.mipmap.delete_icon);
			}
			...
			mViewPager.setAdapter(mPagerAdapter = new AbstractPagerAdapter<String>(this, R.layout.adapter_photopreview, photos) {
				...
				protected void convert(BaseAdapterHelper helper, String item) {
					...
					BitmapHelper.getInstance().displayImage((isFilePath ? "file://" : "") + (getItem(position)), mImageView);
	...
	private void full(boolean enable) {
		...
		if (mTintManager != null)
			mTintManager.setStatusBarTintResource(enable ? R.drawable.transparent : R.mipmap.statusbar_bg);
	}
}
