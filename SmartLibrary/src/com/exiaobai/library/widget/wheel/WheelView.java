...
package com.exiaobai.library.widget.wheel;
 ...
 */
@SuppressLint({ "HandlerLeak", "FloatMath", "ClickableViewAccessibility" })
public class WheelView extends View {
	...
	private final static int ITEM_OFFSET = TEXT_SIZE / 5;
	...
	private void initData(Context context) {
		...
		TEXT_SIZE = getResources().getDimensionPixelSize(R.dimen.font_size_30);
	...
	public String getCurrentItemValue() {
		return getTextItem(getCurrentItem());
	}
