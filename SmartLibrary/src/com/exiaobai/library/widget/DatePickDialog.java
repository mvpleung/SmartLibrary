...
import com.exiaobai.library.listener.DateCallback;
import com.exiaobai.library.widget.KCalendar.OnCalendarClickListener;
import com.exiaobai.library.widget.KCalendar.OnCalendarDateChangedListener;
		...
		calendar.setOnCalendarClickListener(new OnCalendarClickListener() {
			...
			public void onCalendarClick(int row, int col, String dateFormat) {
				...
				if (calendar.getCalendarMonth() - month == 1// 跨年跳转
					...
					calendar.setCalendarDayBgColor(dateFormat, R.mipmap.bg_calendar_seleced);
