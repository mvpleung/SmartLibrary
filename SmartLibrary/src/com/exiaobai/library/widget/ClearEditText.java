 ...
 * 
 * @author
 * @Data LiangZiChao Update By 2014-7-28上午12:16:47
 * @Package com.xiaobai.mobile.view
 */
...
public class ClearEditText extends EditText implements OnFocusChangeListener, TextWatcher {
	...
	private void init() {
		...
		if (mClearDrawable == null) {
			mClearDrawable = getResources().getDrawable(R.mipmap.close_large);
		}
		int size = (int) (getTextSize() * 0.7);
