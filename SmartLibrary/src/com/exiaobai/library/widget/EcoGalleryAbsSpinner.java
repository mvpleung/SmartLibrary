...
import com.exiaobai.library.widget.EcoGallery.EcoGalleryMode;
...
public abstract class EcoGalleryAbsSpinner extends EcoGalleryAdapterView<SpinnerAdapter> {
	 ...
	 * infinite loop
	 */
	public final static int LOOP = 0x1;
	...
	EcoGalleryMode mEcoGalleryMode;
	...
	public void setAdapter(SpinnerAdapter adapter) {
		...
		mAdapter = adapter;
		if (mAdapter instanceof EcoGalleryMode) {
			mEcoGalleryMode = (EcoGalleryMode) mAdapter;
		}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		try {
			...
			if (selectedPosition >= 0 && mAdapter != null && adapterCount > 0 && (isLoopMode() ? selectedPosition % adapterCount : selectedPosition) < adapterCount) {
				// Try looking in the recycler. (Maybe we were measured once
				// already)
				int index = isLoopMode() ? selectedPosition % adapterCount : selectedPosition;
				View view = mRecycler.get(index);
				if (view == null) {
					// Make a new one
	...
	static class SavedState extends BaseSavedState {
		 ...
		 * {@link EcoGalleryAbsSpinner#onSaveInstanceState()}
		 */
	...
	public boolean isLoopMode() {
		return mEcoGalleryMode != null ? mEcoGalleryMode.adapterMode() == LOOP : false;
	}
	...
	public int getAdapterCount() {
		return mEcoGalleryMode != null && mEcoGalleryMode.adapterMode() == LOOP ? mEcoGalleryMode.adapterCount() : mAdapter != null ? mAdapter.getCount() : 0;
	}
