...
public class CustomRadioButton extends CompoundButton {
	...
	public CustomRadioButton(Context context, AttributeSet attrs, int defStyle) {
		...
		mBoundWidth = a.getDimensionPixelSize(R.styleable.CustomRadioButton_boundWidth, getWidth());
		mBoundHeight = a.getDimensionPixelSize(R.styleable.CustomRadioButton_boundHeight, getHeight());
		mTextSize = a.getDimensionPixelSize(R.styleable.CustomRadioButton_android_textSize, Default_TextSize);
		mSubTextSize = a.getDimensionPixelSize(R.styleable.CustomRadioButton_subTextSize, Default_SubTextSize);
		mText = a.getText(R.styleable.CustomRadioButton_android_text);
		mSubText = a.getText(R.styleable.CustomRadioButton_subText);
		mTextColor = a.getColorStateList(R.styleable.CustomRadioButton_android_textColor);
		mSubTextColor = a.getColorStateList(R.styleable.CustomRadioButton_subTextColor);
